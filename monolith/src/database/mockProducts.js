const products = [
  {
    id: "bcb2fa74-90be-487e-8dc0-c6bfd379c633",
  ...
  {
    id: "1d7402b6-522b-42ad-84bc-e58d7402e3fb",
  ...
  {
    id: "d353c4ed-3255-4550-860a-147580c27e89",
  ...
  {
    id: "8ab7a322-9ad7-4f4e-8230-046e214bdc49",
    name: "Terrarium",
    description:
      "This terrarium will looks great in your white painted living room.",
    picture: "static/img/products/terrarium.jpg",
    cost: 36.45,
    categories: JSON.stringify(["gardening"]),
  },
  {
    id: "9cd2319b-75bf-43f0-a8de-785d342edb06",
    name: "Film Camera",
    description:
  ...
  {
    id: "e193cae5-bb27-45d6-afaf-2bf3f724ab5d",
    name: "Vintage Record Player",
    description: "It still works.",
    picture: "static/img/products/record-player.jpg",
    cost: 65.5,
    categories: JSON.stringify(["music", "vintage"]),
  },
  {
    id: "f907da56-dc9b-4a58-b0a9-140cb825f25d",
  ...
  {
    id: "ec90542e-6fb1-4754-805b-c1fdf7224369",
    name: "City Bike",
    description:
      "This single gear bike probably cannot climb the hills of San Francisco.",
    picture: "static/img/products/city-bike.jpg",
    cost: 789.5,
    categories: JSON.stringify(["cycling"]),
  },
  {
    id: "3c0f83df-8e0f-45b5-bc35-9738de337ae9",
    name: "Air Plant",
    description:
